...
const CheckoutList = () =>{
    const {Cart, FinalPrice, Promotions, UserInfoCheck, Email, Adress, CreditCard, ToggleMobileBar, ToggleMainBlock} = useContext(ContextApi);
    ...
    useEffect(()=>{
        ...
        if(toggleMobileBar===true){
            setTimeout(()=>setToggleMainBlock(false),1000)
        }
    },[step, finalPrice])
    return (
        <div>
